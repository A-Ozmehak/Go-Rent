...
import { Button, Center, Flex, FormControl, FormErrorMessage, FormLabel, Image, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Text, Textarea, Toast, useDisclosure, VStack } from "@chakra-ui/react";
            ...
            <VStack spacing={4} align="flex-start">
              ...
              <FormControl isInvalid={!!errors.media && touched.media}>
                {listing.media && (
                  ...
                  <Image h={150} alt={listing.title} src={listing.media}/>
                  </>
                )}
                <FormLabel htmlFor="text">Ladda upp en annan bild</FormLabel>
                <UploadMedia
                  id="media"
           ...
           <Flex 
            ...
            { hovering && ( 
              user?.uid && currentUsername ? (
                <Text cursor="pointer" color="white" fontWeight="bold" fontSize={20} onClick={onOpen}>
                  Redigera Annons
                </Text>
                ):(
